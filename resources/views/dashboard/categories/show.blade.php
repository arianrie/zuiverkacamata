...
<section class="py-1">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-4">
                <img class="card-img-top mb-5 mb-md-0" style="height:400" src="{{ asset('storage/'.$category->image) }}" alt="{{ $category->image }}" /></div>
            <div class="col-md-8">
                <div class="small">{{ $category->created_at }}</div>
                ...
                <div class="fs-10 mb-2">
                    <table>
                        <tr>
                            <td>Slug</td>
                            <td>&nbsp : &nbsp</td>
                            <td><span class="fw-bold"> {{$category->slug }}</span></td>
                        </tr>
                        <tr>
