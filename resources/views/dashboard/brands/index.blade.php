...
<div class="col-12">
    <div class="card mb-4">
      <div class="card-header pb-0">
        <a href="/dashboard/brands/create"><button class="btn btn-primary"><i class="fa fa-plus"></i>  Create Brand</button></a>
      ...
      <div class="card-body px-0 pt-0 pb-2">
        <div class="table-responsive p-0">
          <table class="table align-items-center mb-0 table-responsive">
            ...
            <td>
              <a href="/dashboard/brands/{{ $brand->slug }}" class="badge bg-gradient-info"><i class="fa fa-eye"></i></a>

                <a href="/dashboard/brands/{{ $brand->slug }}/edit"><span class="badge bg-gradient-success small"><i class="fa fa-edit"></i></span></a>
                <form method="post" class="d-inline" action="/dashboard/brands/{{ $brand->slug }}">
                    @method('delete')
                    @csrf
